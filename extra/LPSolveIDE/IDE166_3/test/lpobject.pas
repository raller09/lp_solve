...
interface
uses Classes, windows, lpsolve, dialogs;
...
//  end;
  ...
  private
    ...
    function ChangeLPHandle(newone: THandle): boolean;
  ...
  public
    ...
    property Handle: THandle read FLP;
...
//function std_mktemp(template: PChar): PChar; cdecl; cdecl; external MSVCRT name '_mktemp';
//function std_tmpfile: PInteger; cdecl; cdecl; external MSVCRT name 'tmpfile';
//function std_rmtmp: integer; cdecl; cdecl; external MSVCRT name '_rmtmp';
...
function TLPSolver.ChangeLPHandle(newone: THandle): boolean;
var
