...
unit SynHighlighterXML;
    {$I SynEdit.inc}     // whp the one below was flagged by turbo delphi 2006
{$ENDIF}
...
uses
  ...
  {$IFNDEF LCL} {$ELSE} LclIntf, LMessages, LclType, LResources, {$ENDIF}
  {$IFDEF SYN_CLX}
  Qt, QControls, QGraphics,
  QSynEditTypes,
  QSynEditHighlighter,
  {$ELSE}
  Controls, Graphics, Registry,
  SynEditTypes,
  SynEditHighlighter,
  {$ENDIF}
  SysUtils, Classes;
...
begin
//<HG>
  if (TRangeState(Value) in [low(TRangeState)..High(TRangeState)]) then
//</HG>
