...
uses
  ...
  XPMenu,  ResultArray, lpsolve, lpobject,  VirtualTrees,

  SynEdit, SynEditTypes, LPHighlighter,
  SynEditSearch, SynMemo,
  SynEditRegexSearch, SynEditHighlighter, SynHighlighterXML,
  SynEditMiscClasses, SynEditExport, SynExportHTML,
  SynExportRTF, SynExportTeX, SynEditPlugins, SynMacroRecorder,
  LPSynEdit
...
//      var handled: Boolean);
  ...
  public
    ...
    constructor Create(AOwner: TComponent; LibName, Extension: string; Lang: TLPLanguage); reintroduce;
  end;
...
constructor TNewXliExtension.Create(AOwner: TComponent; LibName,
  Extension: string; Lang: TLPLanguage);
var
  h: THandle;
  m: TMenuItem;
begin
...
constructor TViewXliExtension.Create(AOwner: TComponent; LibName,
  Extension: string; Lang: TLPLanguage);
var
  h: THandle;
  m: TMenuItem;
...
begin
  ...
  case mesg of
    ...
    mLpOptimal, mLpEqual, mLpBetter, mMiLpEqual, mMiLpBetter, mMiLpOptimal:
    begin
...
begin
  ...
  case FScriptFormat of
    ...
    sfMPS:
      begin
        Editor.Lines.Add('* MPS file created by lp_solve v5.0!');
