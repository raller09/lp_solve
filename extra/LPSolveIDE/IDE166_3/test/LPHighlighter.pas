...
const
  Languages: array[TLPLanguage] of string = ('', 'LP', 'CPLEX', 'MPS', 'MATHPROG', 'XML', 'LINDO', 'ZIMPL');
...
var
  ...
  LPKeyWords: array[0..9] of string = ('MAX','MIN','INT','SEC','SOS','SOSX',
...
procedure TLPHighlighter.SetLine(NewValue: String; LineNumber:Integer);
begin
