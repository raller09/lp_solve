...
uses
  ...
  SysUtils, Classes, Controls, SynEdit, Graphics;

type
  TLPSynedit =  class(TSynedit)    ///  class(TCustomSynEdit)   for setcarretxy
  private
    FEnableMPS: boolean;
...
procedure TLPSynedit.PaintTextLines(AClip: TRect;  aFirstRow,
