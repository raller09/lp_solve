...
%c% -I.. -I../.. -I../../shared /LD /MD /Zp8 /Gz -D_WINDLL -D_USRDLL -DWIN32 -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE %src% ../lp_XLI.def /Febin\%PLATFORM%\xli_MPS.dll
...
mt /outputresource:"bin\%PLATFORM%\xli_MPS.dll;#2" /manifest "bin\%PLATFORM%\xli_MPS.dll.manifest"
