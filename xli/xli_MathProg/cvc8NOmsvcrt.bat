...
%c% -I. -I.. -I../.. -I../../shared -I../../colamd -I%glpkdir%\include -I%glpkdir%\src -I"C:\Program Files\MySQL\MySQL Connector C 6.0.2\include" /LD /MT /Zp8 /Gz -D_WINDLL -D_USRDLL -D_CRT_SECURE_NO_DEPRECATE -DWIN32 -D__WOE__ -D_WINSOCKAPI_ -DHAVE_CONFIG_H %src% ../lp_XLI.def /Febin\%PLATFORM%\xli_MathProg.dll
...
rem mt /outputresource:"bin\%PLATFORM%\xli_MathProg.dll;#2" /manifest "bin\%PLATFORM%\xli_MathProg.dll.manifest"
