...
%c% -I.. -I../.. -I../../shared /LD /MT /Zp8 /Gz -D_WINDLL -D_USRDLL -DWIN32 -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DYY_NEVER_INTERACTIVE %src% ../lp_XLI.def /Febin\%PLATFORM%\xli_CPLEX.dll
editbin /LARGEADDRESSAWARE bin\%PLATFORM%\xli_CPLEX.dll
...
rem mt /outputresource:"bin\%PLATFORM%\xli_CPLEX.dll;#2" /manifest "bin\%PLATFORM%\xli_CPLEX.dll.manifest"
