...
%c% -I\FML\xalan\include\src -I\FML\coin\include -I\FML\xerces\include -I\FML\include -I. -I.. -I..\.. -I..\..\shared /LD /MD /Zp8 /Gd /TP /EHsc -D_WINDLL -D_USRDLL -DWIN32 -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DRoleIsExternalLanguageEngine -DLANGUAGE_ACTIVE=LANGUAGE_LPFML %src% /Febin\%PLATFORM%\xli_LPFML.dll /link /IGNORE:4089 /DEF:../lp_XLI.def \Fml\xerces\lib\xerces-c_2.lib \Fml\xalan\lib\Xalan-C_1.lib
...
mt /outputresource:"bin\%PLATFORM%\xli_LPFML.dll;#2" /manifest "bin\%PLATFORM%\xli_LPFML.dll.manifest"
